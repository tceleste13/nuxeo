...
public class TestFileManagerService {
    ...
    @Test
    @Deploy("org.nuxeo.ecm.platform.filemanager:nxfilemanager-test-override.xml")
     ...
     */
    @Test
    @Deploy("org.nuxeo.ecm.platform.filemanager:test-nxfilemanager-mandatory-metadata-contrib.xml")
